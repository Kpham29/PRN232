...
public class FineSlipService : IFineSlipService
{
    ...
    public FineSlipService(IFineSlipRepository fineSlips,
        IBorrowSlipRepository borrowSlips, AppDbContext ctx)
    {
    ...
    public async Task<List<FineSlipDto>> GetByReaderAsync(int readerId)
    {
        var list = await _fineSlips.GetByReaderIdAsync(readerId);
